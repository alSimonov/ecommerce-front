export default function IconYandex({className="w-28 h-28"}){
  return (

      <svg className="fill-red-600" width="30px" height="30px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
